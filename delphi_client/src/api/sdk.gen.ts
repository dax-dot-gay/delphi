...
import type { GetStatusData, GetStatusResponses, LogoutData, LogoutResponses, LogoutErrors, LoginData, LoginResponses, LoginErrors } from './types.gen';
...
export class Root {
    ...
    public static logout<ThrowOnError extends boolean = false>(options?: Options<LogoutData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).delete<LogoutResponses, LogoutErrors, ThrowOnError>({
            url: '/login',
            ...options
        });
    }
